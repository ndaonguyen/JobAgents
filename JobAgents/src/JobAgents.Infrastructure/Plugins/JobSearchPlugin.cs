...
/// invocation is captured onto the event bus by the kernel function filter.
/// </summary>
public sealed class JobSearchPlugin(HttpClient http, IOptions<JobAgentsOptions> options)
{
